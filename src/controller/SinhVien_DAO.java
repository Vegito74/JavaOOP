...
public class SinhVien_DAO implements BasicFunction_Interface<SinhVien_Model> {
    ...
    public int add(SinhVien_Model t) {
        ...
        try {
            ...
            String sql = "INSERT INTO SinhVien (MaSV, TenSV, GioiTinh, NgaySinh, QueQuan, GPA_1, GPA_2, GPA_3, GPA_4, MaLop)\n"
                    + "VALUES (?,?,?,?,?,?,?,?,?,?)";
...
int kq = 0;
        try {
            Connection conn = jdbc_Connect.getConnection();
             String sql = "UPDATE SinhVien SET TenSV = ?, GioiTinh = ?, NgaySinh = ?, QueQuan = ?, GPA_1 = ?, GPA_2 = ?, GPA_3 = ?, GPA_4 = ?, MaLop = ? WHERE MaSV = ?";
            ...
            st.setFloat(5, sv.getGpa_1());
            st.setFloat(6, sv.getGpa_2());
            st.setFloat(7, sv.getGpa_3());
            st.setFloat(8, sv.getGpa_4());
            st.setString(9, sv.getMaClass());
            st.setString(10, sv.getMaSV());
