...
public class SinhVien_Model extends Person{
    ...
    public SinhVien_Model(String maSV, String name, 
            boolean gender, Date dateOfBirth, String queQuan, float gpa_1,
            float gpa_2, float gpa_3, float gpa_4, String maClass) {
    ...
    public float diemXepHang(){
         float sumScore = this.gpa_1 +this.gpa_2+this.gpa_3+this.gpa_4;
         return sumScore;
    } 
    public String xepHangSinhVien(){
       
        if (diemXepHang() > 34.0) {
        return "Giỏi";
    } else if (diemXepHang() > 26.0) {
        return "Khá";
    } else if (diemXepHang() > 15.0) {
        return "Trung bình";
    } else {
        return "Yếu";
    }
